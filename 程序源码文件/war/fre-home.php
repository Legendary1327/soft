    ...
    <div class="middle">
        <div class="navigate">
            ...
            <div class="content_nav">
                ...
                <div class="jud" onclick="window.location='war-jud.php';"><a>审核</a></div>
                <div class="all" onclick="window.location='war-all.php';"><a>库存查看</a></div>
                <div class="add" onclick="window.location='war-add.php';"><a>添加库存</a></div>
                <!--                <div class="que" onclick="window.location='fre-quest.php';"><a>分配任务</a></div>-->
                <div class="car" onclick="window.location='fre-car.php';"><a>分配任务</a></div>
                <div class="rea" onclick="window.location='fre-ready.php';"><a>出车信息</a></div>
                <div class="his" onclick="window.location='fre-his.php';"><a>送货记录</a></div>
