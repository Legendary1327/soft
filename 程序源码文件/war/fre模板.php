    ...
    <div class="middle">
        <div class="navigate">
            ...
            <div class="content_nav">
                <div class="main" onclick="window.location='fre-home.php';"><a>个人主页</a></div>
                <div class="inout" onclick="window.location='fre-quest.php';"><a>可用任务</a></div>
                <div class="que" onclick="window.location='fre-car.php';"><a>车辆信息</a></div>
                <div class="que" onclick="window.location='fre-ready.php';"><a>出车信息</a></div>
                <div class="que" onclick="window.location='fre-his.php';"><a>历史记录</a></div>
