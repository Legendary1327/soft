            ...
            <div class="content_bg">
                <div class="content">
                    ...
                    <table class="tab_cargo_info" >
                        ...
                        <?php
                        $sql = "select * from freight_info where fre_state = 3;";
                        ...
                        if ($number != 0) {
                            for($i = 0; $i < $number; $i++) {
                                ...
                                $str_car = '<tr>
<td>' . $row['fre_id'] . '</td><td>' . $row['fre_truck_id'] . '</td><td>' . $row['fre_total_vol'] . '</td>
<td>' . $row['fre_destination'] . '</td><td>' . $row['fre_start_time'] . '</td>
<td>' . $row['fre_arr_time'] . '</td></tr>';
                                echo $str_car;
                            }
                        }
                        ?>
